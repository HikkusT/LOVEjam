...
function Projectile:new(area, x, y, opts)
    ...
    self.timer:tween(1, self, {velocity = self.velocity * 2, width = self.width/1.5, length = self.length * 1.5, color = {254, 73, 170}}, 'in-quad', function() self.dead = true end)
end
